...
AOSP 為 **Android Open Source Project** 的縮寫，白話來說就是 Android 的原始碼。這份教材會以探討 AOSP 的設計架構為主軸。

由於大部份人都是使用 Mac / Linux 開發，因此本教材基於 Mac OS X & Ubuntu 14.04.4 LTS 編寫。如果您使用的是其他 Linux 系統則建議參考教材進行調整（可直接參考 [AOSP 官方網站](https://source.android.com/index.html)）。
